...
const quizType = document.getElementById('type');
...
function createTableFromObject(data) {
    ...
    tbody.innerHTML = `<tr><td><strong>Country Code</strong></td>
    <td><strong>Country Name</strong></td></tr>`
...
const table = createTableFromObject(countriesData);
